import { createAgent, createNetwork, createState, createTool, Message, openai, type Tool } from '@inngest/agent-kit';
...
export const codeAgentFunction = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        const fragmentTitleGenerator = createAgent({
            ...
            description: "Generate a title for a fragment",
